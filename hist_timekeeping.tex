...
% --- Preamble ---
\title{The science and history of timekeeping in 10 lectures} %
\author{Tom Bensky \\ \texttt{tbensky@calpoly.edu}}\date{\today} % Use \today to automatically insert the current date. Use \date{} to omit the date.
...
\begin{titlepage}
    ...
    \Huge
    \textbf{The History and Science of Timekeeping in 10 lectures}
